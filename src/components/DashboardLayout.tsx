        ...
        <div className="flex flex-col h-full max-h-screen">
          ...
          <nav className="flex-1 overflow-y-auto p-6 lg:p-4 min-h-0">
            <div className="space-y-1">
              ...
              <a href="/travel" className="flex items-center gap-4 px-4 py-4 text-slate-300 hover:text-white hover:bg-slate-700 rounded-xl transition-all duration-200 min-h-[52px]">
                <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span className="font-medium">BH Du lịch</span>
              </a>
              ...
              {user.role === 'admin' && (
                <>
                  ...
                  <a href="/dashboard/settings/car-data" className="flex items-center gap-4 px-4 py-4 text-slate-300 hover:text-white hover:bg-slate-700 rounded-xl transition-all duration-200 min-h-[52px]">
                    <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span className="font-medium">Car Data</span>
                  </a>
                </>
              )}
            </div>
